...
const CustomerSupport: FC<CustomerSupportProps> = ({ onSubscribe, onEnquiry }) => {
  return (
    ...
    <div className="space-y-5 ">
      ...
      <div className="space-y-5 border-[1px] border-[lightGray] p-5 rounded-lg">
      ...
      <div className="border-[1px] border-[lightGray] p-5 rounded-lg flex flex-col justify-center items-center gap-6">
